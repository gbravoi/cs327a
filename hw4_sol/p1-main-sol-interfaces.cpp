 ...
 *
 * This solution allows you to choose between 3 trajectories for the object:
 *		1) along y-axis
 *		2) unit circle in the xy-plane
 *		3) unit circle in the yz-plane
 *
...
const string world_fname = "resources/hw4_sol/world_1_puma.urdf";
...
const string object_fname = "resources/hw4_sol/object.urdf";
...
int main (int argc, char** argv) {
	...
	// get trajectory
	if (argc < 2) {
		cout << "Usage: ./hw4-p3-sol <trajectory: 1 or 2 or 3>" << endl;
		return 0;
	}
	...
	while (fSimulationRunning) { //automatically set to false when simulation is quit
		...
		if (control_mode == CONTROL_AUGMENTED_OBJECT) { 
			...
			case TRAJECTORY1: //y-axis
				obj_des_pos << 0.0, 0.15*sin(5.0*M_PI/3.0*curr_time), 0.4;
				break;
